...
Page({
  ...
  data: {
    ...
    rule: 'up',
    items: [
      { name: 'up', value: '距离过远报警' ,checked:'ture'},
      { name: 'down', value: '距离过近报警' },
    ]
  },*/
/*
  ...
  getDataFromOneNet: function(){
    ...
    const requestTask = wx.request({
      url: 'https://api.heclouds.com/devices/503142779/datapoints?datastream_id=Light,Temperature,Humidity&limit=15',
      header: {
        'content-type': 'application/json',
        'api-key': '5Mwc7R5tBULd3JWiBA43tw=u5Ko='
      },
      success: function (res) {
  ...
  getDataFromOneNet1: function () {
    //从oneNET请求我们的超声波距离的数据
    const requestTask = wx.request({
      url: 'https://api.heclouds.com/devices/505096744/datapoints?datastream_id=distance,pix2&limit=15',
     header: {
       'content-type': 'application/json',
       'api-key': '5Mwc7R5tBULd3JWiBA43tw=u5Ko='
     },
